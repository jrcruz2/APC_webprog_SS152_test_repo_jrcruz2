...
class Users_model2 extends CI_Model
{
    ...
    function json() {
        ...
        $this->datatables->add_column('action', anchor(site_url('users2/read/$1'),'Read')." | ".anchor(site_url('users2/update/$1'),'Update')." | ".anchor(site_url('users2/delete/$1'),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'user_id');
...
/* End of file Users_model2.php */
/* Location: ./application/models/Users_model2.php */
